...
Usage:
  ...
  yeoul search --db PATH --query TEXT [--type fact,episode,entity] [--group-id IDS] [--as-of RFC3339] [--valid-at RFC3339] [--valid-from RFC3339] [--valid-to RFC3339] [--space ID] [--limit N] [--include-related] [--json]
